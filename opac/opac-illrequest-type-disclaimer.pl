...
# If the request already has a type disclaimer filled out or this prompt has
# been used, don't let it be reused.
if ( $request->get_type_disclaimer_date || $prompt->date_replied ) {
