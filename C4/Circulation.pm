...
sub CanBookBeIssued {
    ...
    #TODO: This is correct but needs more work in addition to what's already here:
    # It needs  also be set if patron being checked out to is an ILL_PARTNER and/or the item being checkout is linked to a hold to said patron
    $needsconfirmation{SUPPLY_ILL} = $params->{supplyill} if $params->{supplyill};
