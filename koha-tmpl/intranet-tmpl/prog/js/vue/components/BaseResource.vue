<template>
    ...
    >
        ...
        <template #filters="{ table }">
            <ResourceListFilters
                v-if="instancedResource.resourceListFiltersRequired"
                :instancedResource="instancedResource"
                :table="table"
            />
        </template>
    ...
    data() {
        const optionalResourceProps = {
            ...
            resourceListFiltersRequired:
                this.instancedResource.resourceListFiltersRequired || null,
            formGroupsDisplayMode:
                this.instancedResource.formGroupsDisplayMode || null,
            appendToShow: this.instancedResource.appendToShow || null,
