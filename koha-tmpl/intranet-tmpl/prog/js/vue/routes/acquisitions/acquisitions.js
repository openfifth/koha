...
export const routes = [
    {
        ...
        children: [
            ...
            {
                path: "/cgi-bin/koha/acquisitions/settings",
                title: $__("Settings"),
                disabled: true,
                icon: "fa fa-cogs",
                children: [
                    {
                        path: "marc_order_accounts",
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            {
                                path: "edi_ean_accounts",
                                title: $__("Library EAN accounts"),
                                icon: "fa fa-barcode",
                                resource:
                                    "Acquisitions/EdiEanAccountResource.vue",
                                children: [
                                    {
                                        path: "",
                                        component: markRaw(ResourceWrapper),
                                        name: "EdiEanAccountList",
                                        title: $__("List library EAN accounts"),
                                        permission: "edi_manage",
                                        is_navigation_item: false,
                                    },
                                    {
                                        path: ":edi_ean_account_id",
                                        component: markRaw(ResourceWrapper),
                                        name: "EdiEanAccountShow",
                                        title: $__("Show library EAN account"),
                                        permission: "edi_manage",
                                        is_navigation_item: false,
                                    },
                                    {
                                        path: "add",
                                        component: markRaw(ResourceWrapper),
                                        name: "EdiEanAccountFormAdd",
                                        title: $__("Add library EAN account"),
                                        permission: "edi_manage",
                                        is_navigation_item: false,
                                    },
                                    {
                                        path: "edit/:edi_ean_account_id",
                                        component: markRaw(ResourceWrapper),
                                        name: "EdiEanAccountFormAddEdit",
                                        title: $__("Edit library EAN account"),
                                        permission: "edi_manage",
                                        is_navigation_item: false,
                                    },
                                ],
                    ...
                    },
                    {
                        ...
                        resource: "Acquisitions/CurrencyResource.vue",
                        children: [
                            {
                                path: "",
                                component: markRaw(ResourceWrapper),
                                name: "CurrencyList",
                                title: $__("List currencies"),
                                permission: "budget_manage_all",
                                is_navigation_item: false,
                            },
                            {
                                path: ":currency",
