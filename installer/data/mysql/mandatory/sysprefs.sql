...
('EdiBlockDuplicateInvoiceEmailAddresses', '', NULL, 'Comma-separated list of acquisitions staff email addresses to use when EdiBlockDuplicateInvoiceEmailNotice is set to specific email addresses.', 'Textarea'),
('EdiBlockDuplicateInvoiceEmailNotice', '0', '0|AcquisitionsDefaultEmailAddress|EdiBlockDuplicateInvoiceEmailAddresses|KohaAdminEmailAddress', 'Send duplicate EDIFACT invoice block notifications using the EDI_DUP_INV_LIBRARY notice template to the selected address. Vendor EDI contacts are always notified separately via EDI_DUP_INV_VENDOR. Requires EdiBlockDuplicateInvoice to be enabled.', 'Choice'),
...
('OpacElasticsearchEscapeCharacters', '', NULL, 'List of characters to always escape in OPAC Elasticsearch searches', 'Free'),
...
('UseEmailReceipts','0',NULL,'Send email receipts for payments and write-offs','YesNo'),
('UseGuarantorQuota','0',NULL,'Use guarantor quota instead of guarantee quota when checking out items if one exists and has enough quota available','YesNo'),
