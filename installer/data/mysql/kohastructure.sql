...
CREATE TABLE `fiscal_period` (
  ...
  `spend_limit` decimal(28,6) DEFAULT 0.000000 COMMENT 'spend limit for the fiscal_period',
...
CREATE TABLE `ledgers` (
  ...
  `spend_limit` decimal(28,6) DEFAULT 0.000000 COMMENT 'spend limit for the ledger',
