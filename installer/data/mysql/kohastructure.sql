...
CREATE TABLE `iso18626_requests` (
  ...
  `requestingAgencyId` varchar(80) DEFAULT NULL COMMENT 'Requesting agency ID',
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'Date and time when the request was made',
