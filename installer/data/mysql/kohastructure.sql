...
DROP TABLE IF EXISTS `acq_orderline_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `acq_purchase_orders`
--

DROP TABLE IF EXISTS `acq_purchase_orders`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `library_groups` (
  ...
  `ft_acquisitions` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Use this group to identify libraries for use in the acquisitions module',
