...
subtest 'Basic object tests' => sub {
    ...
    is(
        $mark_comp_return->{template}, '/tmp/Mock/intra-includes/complete.inc',
        "ILL_STATUS_ALIAS is not empty. Template to render is complete.inc"
    );
    ...
    is(
        $mark_comp_return->{next}, 'illview',
        "ILL_STATUS_ALIAS is empty. Skip 'complete' template and go straight to illview"
    );
