...
subtest 'cascade_to_ledgers' => sub {
    ...
    my $updated_ledger_1 = Koha::Acquisition::Finances::Ledgers->find( $ledger_1->ledger_id );
    my $updated_ledger_2 = Koha::Acquisition::Finances::Ledgers->find( $ledger_2->ledger_id );
