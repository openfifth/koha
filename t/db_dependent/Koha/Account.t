...
subtest 'add_lost_replacement_fee() tests' => sub {
    ...
    $account->add_lost_replacement_fee(
        { item => $item, issue_id => $issue->issue_id, library_id => $library->branchcode, interface => 'cron' } );
    is(
    ...
    $account->add_lost_replacement_fee(
        { item => $item_2, issue_id => $issue_2->issue_id, library_id => $library->branchcode, interface => 'cron' } );
    ...
    t::lib::Mocks::mock_preference( 'useDefaultReplacementCost', 1 );
    $account->add_lost_replacement_fee(
        { item => $item_3, issue_id => $issue_3->issue_id, library_id => $library->branchcode, interface => 'cron' } );
    ...
    $account->add_lost_replacement_fee(
        { item => $item_4, issue_id => $issue_4->issue_id, library_id => $library->branchcode, interface => 'cron' } );
    my $processing =
