...
subtest 'list() tests' => sub {
    ...
    $t->get_ok("//$userid:$password@/api/v1/acquisitions/ledgers")
        ->status_is(200)
    ...
    $t->get_ok(qq~//$userid:$password@/api/v1/acquisitions/ledgers?q=[{"me.code":{"like":"%ko%"}}]~)
        ->status_is(200)
        ->json_is( [] );
    ...
    $t->get_ok("//$userid:$password@/api/v1/acquisitions/ledgers?blah=blah")
        ->status_is(400)
...
subtest 'add() tests' => sub {
    ...
    my $ledger_id =
        ...
        ->json_is( '/description'          => $ledger->{description} )
        ->json_is( '/code'                 => $ledger->{code} )
        ->json_is( '/status'               => $ledger->{status} )
        ->json_is( '/owner_id'             => $ledger->{owner_id} )
        ->json_is( '/lib_group_visibility' => $ledger->{lib_group_visibility} )
        ->tx->res->json->{ledger_id};
