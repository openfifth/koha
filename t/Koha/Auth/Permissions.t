...
subtest 'superlibrarian tests' => sub {
    ...
    my $expected = {
        ...
        'CAN_user_ill'                                              => 1,
        'CAN_user_item_lists_create_item_lists'                     => 1,
        'CAN_user_item_lists_edit_item_lists'                       => 1,
        'CAN_user_item_lists_delete_item_lists'                     => 1,
        'CAN_user_item_lists_manage_item_list_contents'             => 1,
        'CAN_user_item_lists'                                       => 1,
