...
subtest 'superlibrarian tests' => sub {
    ...
    my $expected = {
        ...
        'CAN_user_clubs'                                            => 1,
        'CAN_user_displays_add_displays'                            => 1,
        'CAN_user_displays_add_displays_to_any_libraries'           => 1,
        'CAN_user_displays_view_displays'                           => 1,
        'CAN_user_displays_view_displays_from_any_libraries'        => 1,
        'CAN_user_displays_edit_displays'                           => 1,
        'CAN_user_displays_edit_displays_from_any_libraries'        => 1,
        'CAN_user_displays_delete_displays'                         => 1,
        'CAN_user_displays_delete_displays_from_any_libraries'      => 1,
        'CAN_user_displays_manage_display_items'                    => 1,
