use utf8;
package Koha::Schema::Result::ItemsBackup;
...
Koha::Schema::Result::ItemsBackup
...
=head1 TABLE: C<items_backup>

=cut

__PACKAGE__->table("items_backup");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YxIlpCK+lOemlq5g0jPFeg
