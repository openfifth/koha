use utf8;
package Koha::Schema::Result::AcqOrderlineManager;
...
=head1 TABLE: C<acq_orderline_managers>

=cut

__PACKAGE__->table("acq_orderline_managers");
...
sub koha_object_class {
    'Koha::Acquisition::OrderManagement::OrderlineManager';
}

sub koha_objects_class {
    'Koha::Acquisition::OrderManagement::OrderlineManagers';
}
